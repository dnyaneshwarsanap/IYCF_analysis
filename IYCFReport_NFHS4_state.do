...
putdocx save iycf_NFHS-4, replace 
*------------------------------------------------------------------------------------*
...
putdocx save iycf_NFHS-4, append
*------------------------------------------------------------------------------------
...
putdocx text ("Figure 1: Breastfeeding w.r.t age in months area graph (NFHS-4 2005-06)")
putdocx paragraph, halign(center)
...
graph twoway (lpoly carb  agemos [aw=nat_wgt], degree(1) /// Grains roots tubers
         title("IYCF food groups consumed - NFHS-4 2016-18") ///
