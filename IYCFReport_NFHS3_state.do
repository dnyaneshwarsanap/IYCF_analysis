...
* Add dependencies
* this code uses IYCF vars from NFHS-3 data which are created in in make vars do file
...
//use "C:\Temp\iycf_cnns.dta", clear 
 use "C:\Users\dnyan\OneDrive\Documents\UNICEF FELLOWSHIP\CNNS\Merged\iycf_NFHS3.dta", clear
...
putdocx text ("1.1 Ever Breastfed by state level variables")
...
* add title
putdocx table `TableNum'(1,1) = ("Table 1.1: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
...
putdocx save iycf_NFHS-3, replace 
*------------------------------------------------------------------------------------*
...
putdocx save iycf_NFHS-3, append
*------------------------------------------------------------------------------------
...
putdocx pagebreak
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("1.2 Early initiation of breastfeeding (EIBF) by state level variables")
* Define variables for table
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 1.2: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
putdocx pagebreak
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("1.3 Exclusively breastfed for the first two days after birth (EBF2D) by state level variables")
* Define variables for table
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 1.3: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
putdocx pagebreak
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("1.4 Exclusive breastfeeding under six months (EBF) by state level variables")
* Define variables for table
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 1.4: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
//replace diet=3 if currently_bf==1 & tea_coff==1 
...
putdocx text ("Figure 1: Breastfeeding w.r.t age in months area graph (NFHS3 2005-06)")
putdocx paragraph, halign(center)
...
putdocx pagebreak
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("1.5 Mixed milk feeding under six months (MixMF) by state level variables")
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 1.5: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
putdocx pagebreak
putdocx paragraph, style(Title)
putdocx text ("Bottle feeding w.r.t age in months (NFHS-3 2005-06)")
putdocx paragraph, halign(center)
putdocx image malnutrition_agemos.tif, linebreak(1)
putdocx paragraph, style(Heading2)
putdocx text ("Figure 2: Bottle Feeding (did child drink anything from bottle) w.r.t age in months (NFHS-3 2005-06)")
putdocx paragraph, halign(center)
...
putdocx pagebreak
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("1.6. Continued breastfeeding (CBF) in children of 12–23 months by state level variables")
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 1.6: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("2.1 Introduction of solid, semi-solid or soft foods 6–8 months (ISSSF) by state level variables")
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 2.1: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
graph twoway (lpoly carb  agemos [aw=nat_wgt], lcolor(olive) degree(1) /// Grains roots tubers
		title("IYCF food groups consumed - NFHS-3 2005-06") ///
...
putdocx pagebreak
putdocx paragraph, style(Title)
putdocx text ("IYCF consumption of food groups w.r.t age in months (NFHS-3 2005-06)")
putdocx paragraph, halign(center)
putdocx image foodgroups_agemos.tif, linebreak(1)
putdocx paragraph, style(Heading2)
putdocx text ("Figure 3: IYCF consumption of food groups w.r.t age in months (NFHS-3 2005-06)")
putdocx paragraph, halign(center)
...
putdocx pagebreak
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("2.2 Minimum dietary diversity (MDD) for children under 6–23 months by state level variables")
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 2.2: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
putdocx pagebreak
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("2.3 Minimum meal frequency (mmf_all) for children under 6–23 months by state level variables")
* Define variables for table
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 2.3: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
local TableName = "Minimum meal frequency (mmf_all) by early ANC visit (ANC visit in 1st trimester)"
local TableNum = "table2"
local Var = "mmf_all" 
local RowVar = "state"
local ColVar = "earlyanc"
...
putdocx pagebreak
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("2.4 Minimum milk feeding frequency (MMFF) for non-breastfed children under 6–23 months by state level variables")
* Define variables for table
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 2.4: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
putdocx pagebreak
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("2.5 Minimum acceptable diet (MAD) in children under 6-23 months by state level variables")
* Define variables for table
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 2.5: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
putdocx pagebreak
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("2.6 Egg and/or flesh food consumption (EFF) in children under 6-23 months by state level variables")
* Define variables for table
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 2.6: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
putdocx paragraph, style(Title) halign(left) spacing(line,13 pt)
putdocx text ("2.9 Zero vegetable or fruit consumption (ZVF) in children under 6–23 months by state level variables")
...
putdocx table `TableNum' = (`RowCount', 3), border(all, nil) width(90%) layout(autofitwindow) note()
* add title
putdocx table `TableNum'(1,1) = ("Table 2.9: Percentage `TableName' by State"), bold font("Calibri", 11) halign(left) colspan(7) linebreak
* add headers
putdocx table `TableNum'(2,1) = ("State"), bold
putdocx table `TableNum'(2,2) = ("Ever Breastfed"), bold halign(center)
putdocx table `TableNum'(2,3) = ("Count"), bold halign(center)
...
graph twoway (lpoly carb  agemos [aw=nat_wgt], degree(1) /// Grains roots tubers
         title("IYCF food groups consumed - NFHS-3 2016-18") ///
