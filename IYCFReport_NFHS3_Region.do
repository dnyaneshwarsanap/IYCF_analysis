...
* Add dependencies
* this code uses IYCF vars from NFHS3 data which are created in in make vars do file
...
putdocx save iycf_NFHS3_region, replace 
*------------------------------------------------------------------------------------*
...
putdocx save iycf_NFHS3_region, append
*------------------------------------------------------------------------------------
...
putdocx text ("Figure 1: Breastfeeding w.r.t age in months area graph (NFHS3 2016-18)")
putdocx paragraph, halign(center)
...
putdocx pagebreak
putdocx paragraph, style(Title)
putdocx text ("Bottle feeding w.r.t age in months (NFHS3 2005-06)")
putdocx paragraph, halign(center)
putdocx image malnutrition_agemos.tif, linebreak(1)
putdocx paragraph, style(Heading2)
putdocx text ("Figure 2: Bottle Feeding (did child drink anything from bottle) w.r.t age in months (NFHS3 2005-06)")
putdocx paragraph, halign(center)
...
graph twoway (lpoly carb  agemos [aw=nat_wgt], lcolor(olive) degree(1) /// Grains roots tubers
		title("IYCF food groups consumed - NFHS3 2005-06") ///
...
putdocx pagebreak
putdocx paragraph, style(Title)
putdocx text ("IYCF consumption of food groups w.r.t age in months (NFHS3 2005-06)")
putdocx paragraph, halign(center)
putdocx image foodgroups_agemos.tif, linebreak(1)
putdocx paragraph, style(Heading2)
putdocx text ("Figure 3: IYCF consumption of food groups w.r.t age in months (NFHS3 2005-06)")
putdocx paragraph, halign(center)
